...

{
    ...
    is(
        PowerShell::Pipeline->new()
            ->add(PowerShell::Cmdlet->new('Mount-DiskImage'))
            ->add(PowerShell::Cmdlet->new('Get-Volume'))
            ->command(),
    ...
    is(
        PowerShell::Pipeline->new()
            ->add(
                PowerShell::Cmdlet->new('Mount-DiskImage')
                    ->parameter('Image', 'C:\\foo\\bar')
    ...
    is(
        PowerShell::Pipeline->new()
            ->add('Mount-DiskImage', [Image => 'C:\\foo\\bar'])
            ->add('Get-Volume')
            ->command(),
